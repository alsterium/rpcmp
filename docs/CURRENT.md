...
The current task is M6 slice 3: adopt and implement the headless schema 2 player
transitions, then policy/history/settings and mock UI/input behavior through
injected ports. Start from the [transition proposal](design/pocket-player-transition-contract.md);
