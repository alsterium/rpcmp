...
def generate(tree: Path, output: Path, hybrid: bool = False) -> None:
    ...
    sound_type = "rpcmp_hybrid_mmio" if hybrid else "rpcmp_sound_mmio"
    sound_start = f"{sound_type} rpcmp_sound ("
    sound = sound_start + section(top, sound_start, "\n);") + "\n);\n"
    signals = (
...
if __name__ == "__main__":
    ...
    generate(args.tree, args.output, args.hybrid)
