...
$testSources = @((Join-Path $repositoryRoot 'tests\rtl\pocket_spike_tb.sv'), (Join-Path $repositoryRoot 'tests\rtl\device_queue_tb.sv'), (Join-Path $repositoryRoot 'tests\rtl\sound_reset_tb.sv'), (Join-Path $repositoryRoot 'tests\rtl\pocket_audio_tb.sv'), (Join-Path $repositoryRoot 'tests\rtl\jt51_model.sv'), (Join-Path $repositoryRoot 'tests\rtl\jt51_audio_tb.sv'), (Join-Path $repositoryRoot 'tests\rtl\m2_fixed_core_tb.sv'), (Join-Path $repositoryRoot 'tests\rtl\m4_mdx_core_tb.sv'), (Join-Path $repositoryRoot 'tests\rtl\stereo_probe_core_tb.sv'))
...
try {
    ...
    foreach ($simulation in @(@{Top='pocket_spike_tb'; Marker='pocket_spike_tb: PASS'}, @{Top='device_queue_tb'; Marker='device_queue_tb: PASS'}, @{Top='sound_reset_tb'; Marker='sound_reset_tb: PASS'}, @{Top='pocket_audio_tb'; Marker='pocket_audio_tb: PASS'}, @{Top='jt51_audio_tb'; Marker='jt51_audio_tb: PASS'}, @{Top='m2_fixed_core_tb'; Marker='m2_fixed_core_tb: PASS'}, @{Top='m4_mdx_core_tb'; Marker='m4_mdx_core_tb: PASS'}, @{Top='stereo_probe_core_tb'; Marker='stereo_probe_core_tb: PASS'})) {
