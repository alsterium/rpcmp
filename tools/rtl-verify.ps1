...
$rtlSources = @((Join-Path $repositoryRoot 'core\rtl\pocket\rpcmp_spike_regs.sv'), (Join-Path $repositoryRoot 'core\rtl\pocket\rpcmp_device_queue.sv'), (Join-Path $repositoryRoot 'core\rtl\pocket\rpcmp_pocket_audio.sv'))
$testSources = @((Join-Path $repositoryRoot 'tests\rtl\pocket_spike_tb.sv'), (Join-Path $repositoryRoot 'tests\rtl\device_queue_tb.sv'), (Join-Path $repositoryRoot 'tests\rtl\pocket_audio_tb.sv'))
...
try {
    ...
    foreach ($simulation in @(@{Top='pocket_spike_tb'; Marker='pocket_spike_tb: PASS'}, @{Top='device_queue_tb'; Marker='device_queue_tb: PASS'}, @{Top='pocket_audio_tb'; Marker='pocket_audio_tb: PASS'})) {
