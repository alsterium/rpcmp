# Work on the current RPCMP task

Read `AGENTS.md` and its required documents. Resolve the active milestone and
remaining acceptance work through [current work](../docs/CURRENT.md).
Implement the requested bounded task within those contracts. If the next gate
