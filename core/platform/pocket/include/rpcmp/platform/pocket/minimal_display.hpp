...
inline constexpr std::array<std::uint32_t, 8> kMinimalPalette{
    0x101820, 0xEBF2F5, 0x244254, 0x72DACB, 0xFF9292, 0x607580, 0x172834, 0xF0C070};
...
public:
  ...
  [[nodiscard]] static bool marquee_needed(const ui::minimal::View& view);
