module rpcmp_stereo_probe_core #(
    ...
    always_comb begin
        ...
        case (operation_index)
             0: operation_kind = 0;
             1: begin operation_address=8'h20; operation_value=8'h47; end
            ...
            13: begin operation_due=CPU_TICKS_PER_SECOND/4; operation_address=8'h08; operation_value=8'h08; end
            14: begin operation_due=CPU_TICKS_PER_SECOND*5/4; operation_address=8'h08; operation_value=8'h00; end
            15: begin operation_due=CPU_TICKS_PER_SECOND*3/2; operation_address=8'h20; operation_value=8'h87; end
            16: begin operation_due=CPU_TICKS_PER_SECOND*7/4; operation_address=8'h08; operation_value=8'h08; end
            17: begin operation_due=CPU_TICKS_PER_SECOND*11/4; operation_address=8'h08; operation_value=8'h00; end
            18: begin operation_due=CPU_TICKS_PER_SECOND*3; operation_kind=0; end
        ...
        case (state)
            ...
            PUSH: begin
                ...
                mmio_wr_data=32'h8000_0000|{14'd0,operation_kind,operation_address,operation_value};
            end
    ...
    always_ff @(posedge clk_cpu or negedge reset_n) begin
        if (!reset_n) begin
            ...
            WRITE_HI: state <= PUSH;
            PUSH: if (operation_index == 18) begin
                sequence_enqueued <= 1;
                state <= DONE;
            end else begin
